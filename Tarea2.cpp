...
void teclado(unsigned char Key, int x, int y) {
	...
	x = esquina00[0] * matrix[0] + esquina00[1] * matrix[4] + esquina00[2] * matrix[8] + esquina00[3] * matrix[12];
	y = esquina00[0] * matrix[1] + esquina00[1] * matrix[5] + esquina00[2] * matrix[9] + esquina00[3] * matrix[13];
	if (x > 800 || x < -100 || y>600 || y < -100)
		exit(1);
	x = esquina10[0] * matrix[0] + esquina10[1] * matrix[4] + esquina10[2] * matrix[8] + esquina10[3] * matrix[12];
	y = esquina10[0] * matrix[1] + esquina10[1] * matrix[5] + esquina10[2] * matrix[9] + esquina10[3] * matrix[13];
	if (x > 800 || x < -100 || y>600 || y < -100)
		exit(1);
	x = esquina01[0] * matrix[0] + esquina01[1] * matrix[4] + esquina01[2] * matrix[8] + esquina01[3] * matrix[12];
	y = esquina01[0] * matrix[1] + esquina01[1] * matrix[5] + esquina01[2] * matrix[9] + esquina01[3] * matrix[13];
	if (x > 800 || x < -100 || y>600 || y < -100)
		exit(1);
	x = esquina11[0] * matrix[0] + esquina11[1] * matrix[4] + esquina11[2] * matrix[8] + esquina11[3] * matrix[12];
	y = esquina11[0] * matrix[1] + esquina11[1] * matrix[5] + esquina11[2] * matrix[9] + esquina11[3] * matrix[13];
	if (x > 800 || x < -100 || y>600 || y < -100)
		exit(1);
	glutPostRedisplay();
}
...
void cuadrado(double x, double y) {
	glBegin(GL_POLYGON);
	glVertex3f(x, y, 0);
...
void main(int argc, char** argv) {
	...
	glutDisplayFunc(cuadroAleatorio); //Función que pinta
